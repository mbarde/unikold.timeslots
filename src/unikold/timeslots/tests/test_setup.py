...
from unikold.timeslots.interfaces import IUnikoldTimeslotsLayer
...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.is_product_installed("unikold.timeslots"))

    def test_browserlayer(self):
        """Test that IUnikoldTimeslotsLayer is registered."""

        self.assertIn(IUnikoldTimeslotsLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.is_product_installed("unikold.timeslots"))

    def test_browserlayer_removed(self):
        """Test that IUnikoldTimeslotsLayer is removed."""
        self.assertNotIn(IUnikoldTimeslotsLayer, utils.registered_layers())
